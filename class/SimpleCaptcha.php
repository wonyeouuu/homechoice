...
;
	...
	public function __construct($config = array()) {
		foreach($this->fonts as $key => $value){
			$this->fonts[$key]['minSize'] = round($this->fonts[$key]['minSize'] * 0.5); 
			$this->fonts[$key]['maxSize'] = round($this->fonts[$key]['maxSize'] * 0.5); 
		}
	}
	...
	public function CreateImage() {
		...
		$writeText = implode(' ', str_split($text));
		$this->WriteText ( $writeText, $fontcfg );
