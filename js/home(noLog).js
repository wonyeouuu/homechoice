...
var introTransfer = function(introStateF) {
	...
	if (introStateF%4 == 1) { //treatMethod
		...
		//audio here
		$('#nurseAudio').attr("src", '../resources/audio/nurse/ch/treat.mp3');
		...
		//audio here
		$('#nurseAudio').attr("src", '../resources/audio/nurse/ch/exterior.mp3');
		$('#nurseAudio').trigger('play');
		//speaking content
		...
		//audio here
		$('#nurseAudio').attr("src", '../resources/audio/nurse/ch/operate.mp3');
		$('#nurseAudio').trigger('play');
		//speaking content
		...
		//audio here
		$('#nurseAudio').attr("src", '../resources/audio/nurse/ch/vedio.mp3');
		$('#nurseAudio').trigger('play');
		//speaking content
