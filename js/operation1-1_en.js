...
var mainTransfer = function() {
  ...
  if (state == 1) {
    ...
    $('#screenContentValue1').hide();
    $('#screenContentValue2').hide();
    $('#comma').hide();
  }
    ...
    intervalDown = setInterval(function() {downTransfer2(downState)}, 400);//shining
    $('#contentWord').html('治療方式為' + mod1v + '請按向下鍵');//text modify
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/ccpd_en.mp3');
    $('#nurseAudio').trigger('play');
  }
  else if (state == 4.5) {
    ...
    $('#screenContentValue1').show();
    $('#screenContentValue2').show();
    $('#comma').show();

    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/92 8time_en.mp3');
    $('#nurseAudio').trigger('play');
  }
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/70kilo_en.mp3');
    $('#nurseAudio').trigger('play');
  }
    ...
    setTimeout(function() {
      $('#screenContentWord').html('<ul>留置時間：</ul><ul>1:32</ul>');//text modify
      setTimeout(function() {
      $('#screenContentWord').text('按綠色鍵開始執行');//text modify
    }, 2000);  
    }, 2000);
