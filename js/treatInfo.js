...
var introTransfer = function(introStateF) {
	...
	if (introStateF%3 == 1) { //APD treat intro light1
		...
		//audio here
		$('#nurseAudio').attr("src", '../resources/audio/nurse/ch/APDtreat.mp3');
		...
		$('#light3').css("opacity", "0.2");
		//audio here
		$('#nurseAudio').attr("src", '../resources/audio/nurse/ch/compare.mp3');
		$('#nurseAudio').trigger('play');
		//speaking content
		...
		//audio here
		$('#nurseAudio').attr("src", '../resources/audio/nurse/ch/question.mp3');
		$('#nurseAudio').trigger('play');
		//speaking content
