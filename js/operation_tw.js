...
var introTransfer = function(introStateF) {
  ...
  if (introStateF%4 == 1) { //1
    ...
    //audio here
    $('#nurseAudio').attr("src", '../resources/audio/nurse/ch/setting_tw.mp3');
    ...
    //audio here
    $('#nurseAudio').attr("src", '../resources/audio/nurse/ch/prepare_tw.mp3');
    $('#nurseAudio').trigger('play');
    //speaking content
    ...
    //audio here
    $('#nurseAudio').attr("src", '../resources/audio/nurse/ch/solve_tw.mp3');
    $('#nurseAudio').trigger('play');
    //speaking content
    ...
    //audio here
    $('#nurseAudio').attr("src", '../resources/audio/nurse/ch/treatover_tw.mp3');
    $('#nurseAudio').trigger('play');
    //speaking content
