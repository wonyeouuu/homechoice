...
var mainTransfer = function() {
  ...
  if (state == 1) {
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/ccpd.mp3');
    $('#nurseAudio').trigger('play');
  }
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/10000ML.mp3');
    $('#nurseAudio').trigger('play');
  }
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/10time.mp3');
    $('#nurseAudio').trigger('play');
  }
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/2000mllast.mp3');
    $('#nurseAudio').trigger('play');
  }
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/same.mp3');
    $('#nurseAudio').trigger('play');
  }
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/75kilo.mp3');
    $('#nurseAudio').trigger('play');
  }
