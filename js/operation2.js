...
var mainTransfer = function() {
  ...
  if (state == 1) {
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/poweron.mp3');
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/closeall.mp3');
    $('#nurseAudio').trigger('play');
  }
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/open.mp3');
    $('#nurseAudio').trigger('play');
  }
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/put.mp3');
    $('#nurseAudio').trigger('play');
  }
  else if (state == 7) {
    intervalGo = setInterval(function() {goTransfer2(goState)}, 400);//shining
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/takeout.mp3');
    $('#nurseAudio').trigger('play');
  }
  else if (state == 8) {
    intervalNext = setInterval(function() {nextTransfer2(nextState)}, 400);//shining
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/2min.mp3');
    $('#nurseAudio').trigger('play');
  }
  else if (state == 9) {
    intervalNext = setInterval(function() {nextTransfer2(nextState)}, 400);//shining
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/followstep.mp3');
    $('#nurseAudio').trigger('play');
  }
  else if (state == 10) {
    intervalNext = setInterval(function() {nextTransfer2(nextState)}, 400);//shining
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/openall.mp3');
    $('#nurseAudio').trigger('play');
  }
  else if (state == 11) {
    intervalGo = setInterval(function() {goTransfer2(goState)}, 400);//shining
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/confirm.mp3');
    $('#nurseAudio').trigger('play');
  }
  else if (state == 12) {
    intervalNext = setInterval(function() {nextTransfer2(nextState)}, 400);//shining
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/exhaust.mp3');
    $('#nurseAudio').trigger('play');
  }
  else if (state == 13) {
    intervalNext = setInterval(function() {nextTransfer2(nextState)}, 400);//shining
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/manual.mp3');
    $('#nurseAudio').trigger('play');
  }
  else if (state == 14) {
    intervalNext = setInterval(function() {nextTransfer2(nextState)}, 400);//shining
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/minifollowstep.mp3');
    $('#nurseAudio').trigger('play');
  }
  else if (state == 15) {
    intervalGo = setInterval(function() {goTransfer2(goState)}, 400);//shining
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/miniopen.mp3');
    $('#nurseAudio').trigger('play');
  }
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/treatstart.mp3');
    $('#nurseAudio').trigger('play');
  }
}
