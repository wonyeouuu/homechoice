...
var mainTransfer = function() {
  ...
  if (state == 1) {
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/greenbutton_en.mp3');
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/minicloseall_en.mp3');
    $('#nurseAudio').trigger('play');   
  }
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/clean_en.mp3');
    $('#nurseAudio').trigger('play');
  }
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/preparecheck_en.mp3');
    $('#nurseAudio').trigger('play');
  }
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/separate_en.mp3');
    $('#nurseAudio').trigger('play');
  }
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/abandon_en.mp3');
    $('#nurseAudio').trigger('play');
  }
  else if (state == 8) {
    intervalGo = setInterval(function() {goTransfer2(goState)}, 400);//shining
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/turnoff_en.mp3');
    $('#nurseAudio').trigger('play');
  }
  else if (state == 10) {
    intervalDown = setInterval(function() {downTransfer2(downState)}, 400);//shining
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/recordwater_en.mp3');
    $('#nurseAudio').trigger('play');
  }
  else if (state == 11) {
    intervalDown = setInterval(function() {downTransfer2(downState)}, 400);//shining
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/recordtime_en.mp3');
    $('#nurseAudio').trigger('play');
  }
  else if (state == 12) {
    intervalDown = setInterval(function() {downTransfer2(downState)}, 400);//shining
