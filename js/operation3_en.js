...
var introTransfer = function(introStateF) {
  ...
  if (introStateF%4 == 1) { 
    ...
    //audio here
    $('#nurseAudio').attr("src", '../resources/audio/nurse/ch/warring_en.mp3');
    ...
    //audio here
    $('#nurseAudio').attr("src", '../resources/audio/nurse/ch/ManualFlowMethod_en.mp3');
    $('#nurseAudio').trigger('play');
    //speaking content
    ...
    //audio here
    $('#nurseAudio').attr("src", '../resources/audio/nurse/ch/skip_en.mp3');
    $('#nurseAudio').trigger('play');
    //speaking content
    ...
    //audio here
    $('#nurseAudio').attr("src", '../resources/audio/nurse/ch/ForceOverMethod_en.mp3');
    $('#nurseAudio').trigger('play');
    //speaking content
