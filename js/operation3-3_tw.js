...
var mainTransfer = function() {
  ...
  if (state == 1) {
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/downbutton_skip_tw.mp3');
    $('#nurseAudio').trigger('play');
  }
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/bluebutton_warring_tw.mp3');
    $('#nurseAudio').trigger('play');
  }
    ...
    $('#APDWarning').trigger('play');
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/redmute_skip_tw.mp3');
    $('#nurseAudio').trigger('play');
  }
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/bluebutton_next_tw.mp3');
    $('#nurseAudio').trigger('play');
  }
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/next_tw.mp3');
    $('#nurseAudio').trigger('play');
  }
