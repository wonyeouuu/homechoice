...
var mainTransfer = function() {
  ...
  if (state == 1) {
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/poweron_en.mp3');
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/closeall_en.mp3');
    $('#nurseAudio').trigger('play');
  }
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/open_en.mp3');
    $('#nurseAudio').trigger('play');
  }
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/put_en.mp3');
    $('#nurseAudio').trigger('play');
  }
  else if (state == 7) {
    intervalGo = setInterval(function() {goTransfer2(goState)}, 400);//shining
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/takeout_en.mp3');
    $('#nurseAudio').trigger('play');
  }
  else if (state == 8) {
    intervalNext = setInterval(function() {nextTransfer2(nextState)}, 400);//shining
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/2min_en.mp3');
    $('#nurseAudio').trigger('play');
  }
  else if (state == 9) {
    intervalNext = setInterval(function() {nextTransfer2(nextState)}, 400);//shining
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/followstep_en.mp3');
    $('#nurseAudio').trigger('play');
  }
  else if (state == 10) {
    intervalNext = setInterval(function() {nextTransfer2(nextState)}, 400);//shining
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/openall_en.mp3');
    $('#nurseAudio').trigger('play');
  }
  else if (state == 11) {
    intervalGo = setInterval(function() {goTransfer2(goState)}, 400);//shining
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/confirm_en.mp3');
    $('#nurseAudio').trigger('play');
  }
  else if (state == 12) {
    intervalNext = setInterval(function() {nextTransfer2(nextState)}, 400);//shining
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/exhaust_en.mp3');
    $('#nurseAudio').trigger('play');
  }
  else if (state == 13) {
    intervalNext = setInterval(function() {nextTransfer2(nextState)}, 400);//shining
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/manual_en.mp3');
    $('#nurseAudio').trigger('play');
  }
  else if (state == 14) {
    intervalNext = setInterval(function() {nextTransfer2(nextState)}, 400);//shining
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/minifollowstep_en.mp3');
    $('#nurseAudio').trigger('play');
  }
  else if (state == 15) {
    intervalGo = setInterval(function() {goTransfer2(goState)}, 400);//shining
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/miniopen_en.mp3');
    $('#nurseAudio').trigger('play');
  }
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/treatstart_en.mp3');
    $('#nurseAudio').trigger('play');
  }
}
