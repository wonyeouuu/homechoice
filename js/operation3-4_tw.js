...
var mainTransfer = function() {
  ...
  if (state == 1) {
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/shutdown10_tw.mp3');
    $('#nurseAudio').trigger('play');
  }
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/turnon_warring_tw.mp3');
    $('#nurseAudio').trigger('play');
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/redmute_power_tw.mp3');
    $('#nurseAudio').trigger('play');
  }
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/downbutton_delete_tw.mp3');
    $('#nurseAudio').trigger('play');
  }
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/downbutton_time_tw.mp3');
    $('#nurseAudio').trigger('play');
  }
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/bluebutton_end_tw.mp3');
    $('#nurseAudio').trigger('play');
  }
}
