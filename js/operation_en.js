...
var introTransfer = function(introStateF) {
  ...
  if (introStateF%4 == 1) { //1
    ...
    //audio here
    $('#nurseAudio').attr("src", '../resources/audio/nurse/ch/setting_en.mp3');
    ...
    //audio here
    $('#nurseAudio').attr("src", '../resources/audio/nurse/ch/prepare_en.mp3');
    $('#nurseAudio').trigger('play');
    //speaking content
    ...
    //audio here
    $('#nurseAudio').attr("src", '../resources/audio/nurse/ch/solve_en.mp3');
    $('#nurseAudio').trigger('play');
    //speaking content
    ...
    //audio here
    $('#nurseAudio').attr("src", '../resources/audio/nurse/ch/treatover_en.mp3');
    $('#nurseAudio').trigger('play');
    //speaking content
