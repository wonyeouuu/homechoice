...
var introTransfer = function(introStateF) {
	...
	if (introStateF%4 == 1) { //treatMethod
		...
		//audio here
		$('#nurseAudio').attr("src", '../resources/audio/nurse/ch/treat_en.mp3');
		...
		//audio here
		$('#nurseAudio').attr("src", '../resources/audio/nurse/ch/exterior_en.mp3');
		$('#nurseAudio').trigger('play');
		//speaking content
		...
		//audio here
		$('#nurseAudio').attr("src", '../resources/audio/nurse/ch/operate_en.mp3');
		$('#nurseAudio').trigger('play');
		//speaking content
		...
		//audio here
		$('#nurseAudio').attr("src", '../resources/audio/nurse/ch/vedio_en.mp3');
		$('#nurseAudio').trigger('play');
		//speaking content
