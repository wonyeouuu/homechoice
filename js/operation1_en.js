...
var introTransfer = function(introStateF) {
  ...
  if (introStateF%4 == 1) { 
    ...
    //audio here
    $('#nurseAudio').attr("src", '../resources/audio/nurse/ch/Prescription_Chen_en.mp3');
    ...
    //audio here
    $('#nurseAudio').attr("src", '../resources/audio/nurse/ch/Prescription_Lee_en.mp3');
    $('#nurseAudio').trigger('play');
    //speaking content
    ...
    //audio here
    $('#nurseAudio').attr("src", '../resources/audio/nurse/ch/Prescription_Wang_en.mp3');
    $('#nurseAudio').trigger('play');
    //speaking content
    ...
    //audio here
    $('#nurseAudio').attr("src", '../resources/audio/nurse/ch/Prescription_Yeh_en.mp3');
    $('#nurseAudio').trigger('play');
    //speaking content
