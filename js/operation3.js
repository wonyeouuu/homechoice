...
var introTransfer = function(introStateF) {
  ...
  if (introStateF%4 == 1) { 
    ...
    //audio here
    $('#nurseAudio').attr("src", '../resources/audio/nurse/ch/warring.mp3');
    ...
    //audio here
    $('#nurseAudio').attr("src", '../resources/audio/nurse/ch/ManualFlowMethod.mp3');
    $('#nurseAudio').trigger('play');
    //speaking content
    ...
    //audio here
    $('#nurseAudio').attr("src", '../resources/audio/nurse/ch/skip.mp3');
    $('#nurseAudio').trigger('play');
    //speaking content
    ...
    //audio here
    $('#nurseAudio').attr("src", '../resources/audio/nurse/ch/ForceOverMethod.mp3');
    $('#nurseAudio').trigger('play');
    //speaking content
