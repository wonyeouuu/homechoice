...
var mainTransfer = function() {
  ...
  if (state == 1) {
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/downbutton_skip_en.mp3');
    $('#nurseAudio').trigger('play');
  }
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/bluebutton_warring_en.mp3');
    $('#nurseAudio').trigger('play');
  }
    ...
    $('#APDWarning').trigger('play');
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/redmute_skip_en.mp3');
    $('#nurseAudio').trigger('play');
  }
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/bluebutton_next_en.mp3');
    $('#nurseAudio').trigger('play');
  }
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/next_en.mp3');
    $('#nurseAudio').trigger('play');
  }
