...
var mainTransfer = function() {
  ...
  if (state == 1) {
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/shutdown10.mp3');
    $('#nurseAudio').trigger('play');
  }
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/turnon_warring.mp3');
    $('#nurseAudio').trigger('play');
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/redmute_power.mp3');
    $('#nurseAudio').trigger('play');
  }
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/downbutton_delete.mp3');
    $('#nurseAudio').trigger('play');
  }
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/downbutton_time.mp3');
    $('#nurseAudio').trigger('play');
  }
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/bluebutton_end.mp3');
    $('#nurseAudio').trigger('play');
  }
}
