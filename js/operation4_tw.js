...
var mainTransfer = function() {
  ...
  if (state == 1) {
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/greenbutton_tw.mp3');
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/minicloseall_tw.mp3');
    $('#nurseAudio').trigger('play');   
  }
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/clean_tw.mp3');
    $('#nurseAudio').trigger('play');
  }
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/preparecheck_tw.mp3');
    $('#nurseAudio').trigger('play');
  }
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/separate_tw.mp3');
    $('#nurseAudio').trigger('play');
  }
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/abandon_tw.mp3');
    $('#nurseAudio').trigger('play');
  }
  else if (state == 8) {
    intervalGo = setInterval(function() {goTransfer2(goState)}, 400);//shining
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/turnoff_tw.mp3');
    $('#nurseAudio').trigger('play');
  }
  else if (state == 10) {
    intervalDown = setInterval(function() {downTransfer2(downState)}, 400);//shining
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/recordwater_tw.mp3');
    $('#nurseAudio').trigger('play');
  }
  else if (state == 11) {
    intervalDown = setInterval(function() {downTransfer2(downState)}, 400);//shining
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/recordtime_tw.mp3');
    $('#nurseAudio').trigger('play');
  }
  else if (state == 12) {
    intervalDown = setInterval(function() {downTransfer2(downState)}, 400);//shining
