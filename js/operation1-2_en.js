...
var mainTransfer = function() {
  ...
  if (state == 1) {
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/10000ML_en.mp3');
    $('#nurseAudio').trigger('play');
  }
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/10time_en.mp3');
    $('#nurseAudio').trigger('play');
  }
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/2000mllast_en.mp3');
    $('#nurseAudio').trigger('play');
  }
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/same_en.mp3');
    $('#nurseAudio').trigger('play');
  }
    ...
    $('#nurseAudio').attr('src', '../resources/audio/nurse/ch/75kilo_en.mp3');
    $('#nurseAudio').trigger('play');
  }
    ...
    setTimeout(function() {
      $('#screenContentWord').html('<ul>留置時間：</ul><ul>1:59</ul>');//text modify
      setTimeout(function() {
      $('#screenContentWord').text('按綠色鍵開始執行');//text modify
    }, 2000);  
    }, 2000);
