...
Routine\Permission::checkPermission ( 'SWI', true );
$page_title = "願望列表";
...
$config = array (
		...
		'title' => $page_title,
		'editUrl' => 'wish-edit.php',
		'initWhere' => ' where 1 ',
		'initSort' => ' order by a.`voteCount`  ',
		'initDesc' => ' desc',
		'cookieName' => 'lp_wish',
		'editPermission' => 'EWI',
		'sortable' => false,
						...
						<div>
							...
							<div class="widget-body list-body">
								<table class="table table-bordered table-hover">
									<thead>
										<tr>
											<th><a href="<?=$_SERVER['PHP_SELF']?>?sort=content">願望內容</a></th>
											<th><a href="<?=$_SERVER['PHP_SELF']?>?sort=addDate">許願日期</a></th>
											<th><a href="<?=$_SERVER['PHP_SELF']?>?sort=voteCount">票數</a></th>
