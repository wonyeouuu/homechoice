...
Routine\Permission::checkPermission ( 'SSR', true );
$page_title = "安裝來源";
...
// Config
$config = array (
		'tblName' => 'install_source',
		'pk' => 'isId',
		'listUrl' => $_SERVER ['PHP_SELF'],
		'title' => $page_title,
		'editUrl' => 'install-edit.php',
		'initWhere' => ' where 1 ',
		'initSort' => ' order by a.`isId`  ',
		'initDesc' => ' desc',
		'cookieName' => 'install_source',
		'editPermission' => 'MSR',
		'sortable' => false,
...
<div id="main" role="main">
	...
	<div id="content">
		...
		<div class="row">
			...
			<div style="float: right; margin: 10px 20px;">
				<a class="btn btn-primary" href="install-export.php">
						...
						<div>
							...
							<div class="widget-body list-body">
								<table class="table table-bordered table-hover">
									<thead>
										<tr>
											<th><a href="<?=$_SERVER['PHP_SELF']?>?sort=installDate" <?php if($key == 'installDate') echo 'style="color:blue;"'?>>日期</a></th>
											<th><a href="<?=$_SERVER['PHP_SELF']?>?sort=system" <?php if($key == 'system') echo 'style="color:blue;"'?>>系統</a></th>
											<th><a href="<?=$_SERVER['PHP_SELF']?>?sort=sId" <?php if($key == 'sId') echo 'style="color:blue;"'?>>來源</a></th>
