...
Routine\Permission::checkPermission ( 'SNW', true );
$page_title = "新聞列表";
...
$config = array (
		...
		'title' => $page_title,
		'editUrl' => 'news-edit.php',
		'initWhere' => ' where 1 ',
		'initSort' => ' order by a.`date`  ',
		'initDesc' => ' desc',
		'cookieName' => 'av_news',
		'editPermission' => 'ENW',
		'sortable' => false,
						...
						<div>
							...
							<div class="widget-body list-body">
								<table class="table table-bordered table-hover">
									<thead>
										<tr>
											<th><a href="<?=$_SERVER['PHP_SELF']?>?sort=firstname" <?php if($key == 'firstname') echo 'style="color:blue;"'?>>標題</a></th>
											<th><a href="<?=$_SERVER['PHP_SELF']?>?sort=lastname" <?php if($key == 'lastname') echo 'style="color:blue;"'?>>日期</a></th>
