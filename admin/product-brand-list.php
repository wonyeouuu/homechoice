...
Routine\Permission::checkPermission ( 'SPB', true );
$page_title = "產品品牌列表";
...
// Config
$config = array (
		'tblName' => 'av_product_brand',
		'pk' => 'brand_id',
		'listUrl' => $_SERVER ['PHP_SELF'],
		'title' => $page_title,
		'editUrl' => 'product-brand-edit.php',
		'initWhere' => ' where 1 ',
		'initSort' => ' order by a.`sort_number`  ',
		'initDesc' => ' asc',
		'cookieName' => 'av_product_brand',
		'editPermission' => 'EPC',
		'sortable' => true,
											...
											<td>
												...
												<a class="btn btn-primary" href="<?php echo $config['editUrl']?>?<?php echo $config['pk']?>=<?php echo $row[$config['pk']]?>">
													...
													<ul class="dropdown-menu">
															...
															<?php if($i == $row[$config['sortField']] || $i == $row[$config['sortField']]+1) continue;?>
