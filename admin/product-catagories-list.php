...
Routine\Permission::checkPermission ( 'SPC', true );
$page_title = "產品類別列表";
...
// Config
$config = array (
		'tblName' => 'av_product_catagories',
		'pk' => 'catagories_id',
		'listUrl' => $_SERVER ['PHP_SELF'],
		'title' => $page_title,
		'editUrl' => 'product-catagories-edit.php',
		'initWhere' => ' where 1 ',
		'initSort' => ' order by a.`sort_number`  ',
		'initDesc' => ' asc',
		'cookieName' => 'av_product_catagories',
		'editPermission' => 'EPC',
		'sortable' => true,
...
$query_sql = "select a.*, b.name product_name
								...
								<table class="table table-bordered table-hover">
									<thead>
										<tr>
											...
											<th><a href="<?=$_SERVER['PHP_SELF']?>?sort=name" <?php if($key == 'name_en') echo 'style="color:blue;"'?>>英文名稱</a></th>
											<th><a href="<?=$_SERVER['PHP_SELF']?>?sort=product_id" <?php if($key == 'product_id') echo 'style="color:blue;"'?>>產品連結</a></th>
											<th><a href="<?=$_SERVER['PHP_SELF']?>?sort=sort_number" <?php if($key == 'sort_number') echo 'style="color:blue;"'?>>排序</a></th>
