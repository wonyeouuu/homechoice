...
use Routine\Permission;
//initilize the page
require_once("inc/init.php");

Permission::isLogined();
	...
	<div id="content">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
				<h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-home"></i> <?php echo $page_title;?> <span>> <?php echo $page_title;?></span></h1>
			</div>
		</div>
		<!-- widget grid -->
		<!-- end widget grid -->
