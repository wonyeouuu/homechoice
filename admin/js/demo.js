var ribbonHtml = '';
ribbonHtml += "<div class=\"demo\">";
ribbonHtml += "	<span id=\"demo-setting\"><i class=\"fa fa-cog txt-color-blueDark\"><\/i><\/span>";
ribbonHtml += "	<form>";
ribbonHtml += "		<legend class=\"no-padding margin-bottom-10\">版面佈置<\/legend>";
ribbonHtml += "		<section>";
ribbonHtml += "			<label><input name=\"subscription\" id=\"smart-fixed-nav\" type=\"checkbox\" class=\"checkbox style-0\"><span>功能列置頂<\/span><\/label><label><input type=\"checkbox\" name=\"terms\" id=\"smart-fixed-ribbon\"";
ribbonHtml += "					class=\"checkbox style-0\"><span>導覽列置頂n<\/span><\/label><label><input type=\"checkbox\" name=\"terms\" id=\"smart-fixed-navigation\" class=\"checkbox style-0\"><span>固定選單<\/span><\/label><label><input";
ribbonHtml += "					type=\"checkbox\" name=\"terms\" id=\"smart-fixed-container\" class=\"checkbox style-0\"><span>固定視窗寬度 <b><\/b>";
ribbonHtml += "					<div class=\"font-xs text-right\">(不適應螢幕寬度)<\/div><\/span><\/label><label style=\"display: none;\"><input type=\"checkbox\" name=\"terms\" id=\"smart-rtl\" class=\"checkbox style-0\"><span>Right to left";
ribbonHtml += "					<b>(rtl)<\/b>";
ribbonHtml += "			<\/span><\/label> <span id=\"smart-bgimages\"><\/span>";
ribbonHtml += "		<\/section>";
ribbonHtml += "		<section>";
ribbonHtml += "			<h6 class=\"margin-top-10 semi-bold margin-bottom-5\">清除本地快取<\/h6>";
ribbonHtml += "			<a href=\"javascript:void(0);\" class=\"btn btn-xs btn-block btn-primary\" id=\"reset-smart-widget\">";
ribbonHtml += "				<i class=\"fa fa-refresh\"><\/i> 重置所有視窗排列";
ribbonHtml += "			<\/a>";
ribbonHtml += "		<\/section>";
ribbonHtml += "		<h6 class=\"margin-top-10 semi-bold margin-bottom-5\">版面顏色<\/h6>";
ribbonHtml += "		<section id=\"smart-styles\">";
ribbonHtml += "			<a href=\"javascript:void(0);\" id=\"smart-style-0\" data-skinlogo=\"<?php echo ASSETS_URL; ?>\/img\/logo.png\" class=\"btn btn-block btn-xs txt-color-white margin-right-5\"";
ribbonHtml += "				style=\"background-color: #4E463F;\">";
ribbonHtml += "				<i class=\"fa fa-check fa-fw\" id=\"skin-checked\"><\/i>預設";
ribbonHtml += "			<\/a>";
ribbonHtml += "			<a href=\"javascript:void(0);\" id=\"smart-style-1\" data-skinlogo=\"<?php echo ASSETS_URL; ?>\/img\/logo-white.png\" class=\"btn btn-block btn-xs txt-color-white\" style=\"background: #3A4558;\">深藍<\/a>";
ribbonHtml += "			<a href=\"javascript:void(0);\" id=\"smart-style-2\" data-skinlogo=\"<?php echo ASSETS_URL; ?>\/img\/logo-blue.png\" class=\"btn btn-xs btn-block txt-color-darken margin-top-5\" style=\"background: #fff;\">亮白";
ribbonHtml += "					<\/a>";
ribbonHtml += "			<a href=\"javascript:void(0);\" id=\"smart-style-3\" data-skinlogo=\"<?php echo ASSETS_URL; ?>\/img\/logo-pale.png\" class=\"btn btn-xs btn-block txt-color-white margin-top-5\" style=\"background: #f78c40\">Google橘";
ribbonHtml += "				<\/a>";
ribbonHtml += "		<\/section>";
ribbonHtml += "	<\/form>";
ribbonHtml += "<\/div>";
