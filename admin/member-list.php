...
$config = array (
		...
		'title' => $page_title,
		'editUrl' => 'member-edit.php',
		'initWhere' => ' where 1 ',
		'initSort' => ' order by a.`add_date`  ',
		'initDesc' => ' desc',
		'cookieName' => 'av_member',
		'editPermission' => 'EMB',
		'sortable' => false,
						...
						<div>
							...
							<div class="widget-body list-body">
								<table class="table table-bordered table-hover">
									<thead>
										<tr>
											<th><a href="<?=$_SERVER['PHP_SELF']?>?sort=firstname" <?php if($key == 'firstname') echo 'style="color:blue;"'?>>First Name</a></th>
											<th><a href="<?=$_SERVER['PHP_SELF']?>?sort=lastname" <?php if($key == 'lastname') echo 'style="color:blue;"'?>>Last Name</a></th>
											<th><a href="<?=$_SERVER['PHP_SELF']?>?sort=email" <?php if($key == 'email') echo 'style="color:blue;"'?>>Email</a></th>
											<th><a href="<?=$_SERVER['PHP_SELF']?>?sort=city" <?php if($key == 'city') echo 'style="color:blue;"'?>>縣市</a></th>
											<th><a href="<?=$_SERVER['PHP_SELF']?>?sort=phone" <?php if($key == 'phone') echo 'style="color:blue;"'?>>電話</a></th>
